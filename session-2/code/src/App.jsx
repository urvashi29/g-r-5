...
// Create employee data in a state and include following fields (name, age, DOB, salary, designation, image, department). Display name, image, designation in UI. Whenever user hover over any name, display complete employee data in alert/modal.
